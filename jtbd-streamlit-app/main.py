...
#                 data, link_mat = HDBSCAN.run(df)
#                 HDBSCAN.dendogram_plotting(data, link_mat)
#             elif algorithm == "K-means Clustering":
#                 data, link_mat = K_means.run(df)
#                 K_means.dendogram_plotting(data, link_mat)
#             elif algorithm == "NNA Analysis":
#                 data, link_mat = NNA.run(df)
#                 NNA.dendogram_plotting(data, link_mat)
#         else:
